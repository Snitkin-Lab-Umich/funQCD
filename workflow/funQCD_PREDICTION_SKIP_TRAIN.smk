...
# to ensure future funannotate steps can find the files from prediction, simply copy predict_results/ to update_results/
rule funannotate_update:
    ...
    params:
        predict_out_dir = "results/{prefix}/funannotate/{sample}/predict_results/",
        update_out_dir = "results/{prefix}/funannotate/{sample}/update_results/",
        reminder_file = "results/{prefix}/funannotate/{sample}/update_results/{sample}_training_skipped.txt",
    threads: 1
    resources:
        mem_mb = 5000,
        runtime = 120,
    ...
    shell:
        """
        cp {params.predict_out_dir} {params.update_out_dir}
        touch {params.reminder_file}
        """
